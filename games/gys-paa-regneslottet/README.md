...
```text
~/retro-game-files/gys-paa-regneslottet/
# or
...
```sh
RETRO_GAME_SOURCE_DIR=~/retro-game-files RETRO_GAME_RUNTIME_DIR=~/retro-game-runtime ./games/gys-paa-regneslottet/launch.sh
```
