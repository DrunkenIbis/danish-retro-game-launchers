...
```text
~/retro-game-files/battle-beast/
# or
local/sources/battle-beast/
```
...
```sh
RETRO_GAME_SOURCE_DIR=~/retro-game-files RETRO_GAME_RUNTIME_DIR=~/retro-game-runtime ./games/battle-beast/launch.sh
```
