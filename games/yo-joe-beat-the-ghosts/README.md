...
```text
~/retro-game-files/yo-joe-beat-the-ghosts/
# or
local/sources/yo-joe-beat-the-ghosts/
```
...
```sh
RETRO_GAME_SOURCE_DIR=~/retro-game-files RETRO_GAME_RUNTIME_DIR=~/retro-game-runtime ./games/yo-joe-beat-the-ghosts/launch.sh
```
