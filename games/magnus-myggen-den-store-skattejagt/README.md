...
```text
~/retro-game-files/magnus-myggen-den-store-skattejagt/
# or
local/sources/magnus-myggen-den-store-skattejagt/
```
...
```sh
RETRO_GAME_SOURCE_DIR=~/retro-game-files RETRO_GAME_RUNTIME_DIR=~/retro-game-runtime ./games/magnus-myggen-den-store-skattejagt/launch.sh
```
